...
for u_v_w in range(3):
    for channel in range(3):
        ...
        for sample_idx in tqdm(range(len(data_shap))):
        ...
        df.to_csv(f'structure_stats_abs_inputs_yp{yp}_channel_{channel}_uvw_{u_v_w}_outputs_ranked_by_shap_step_by_10.csv')
